...
const Layout = ({user, children}) => {
    ...
    const carousel = "http://localhost/php_advertisements/public/carousel";
            ...
            <nav className="bg-indigo-800">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <a href={carousel} target="_blank"
                                       className="px-3 py-2 rounded-md text-sm font-medium text-indigo-300 hover:text-white hover:bg-indigo-700 focus:outline-none focus:text-white focus:bg-indigo-700">Carousel</a>
                ...
                <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} border-b border-gray-700 md:hidden`}>
                    <div className="px-2 py-3 space-y-1 sm:px-3">
                        ...
                        <a href={carousel}
                           className="block px-3 py-2 rounded-md text-base font-medium text-indigo-300 hover:text-white hover:bg-indigo-700 focus:outline-none focus:text-white focus:bg-indigo-700">Carousel</a>
